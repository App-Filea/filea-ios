...
//        givenStore(initialSharedVehicles: [.make()], initialSelectedVehicle: .null())
//        await store.send(.onAppear)
...
//    }
//    
//    private func givenStore(initialSharedVehicles: [Vehicle] = [], initialSelectedVehicle: Vehicle = .null()) {
